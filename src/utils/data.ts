...
export const products: Product[] = [
  {
    id: 1,
    user_id: 1,
    title: 'Adobe Photoshop 2024 Essential Training',
    price: 29.99,
    preview: 'https://cdn.pixabay.com/vimeo/147535892/photoshop-1847.mp4',
    description: 'Explore the wonders of nature in HD',
    content_url: 'https://download.samplelib.com/mp4/sample-30s.mp4',
    thumbnail:
  ...
  },
  {
    id: 2,
    user_id: 2,
    title: 'Mindfulness Meditation Collection',
    price: 14.99,
    preview: 'https://cdn.pixabay.com/audio/2022/11/17/audio_547db67f5f.mp3',
    description: 'Calming forest and water sounds',
    content_url: 'https://download.samplelib.com/mp3/sample-12s.mp3',
    thumbnail:
  ...
  },
  {
    id: 4,
    user_id: 4,
    title: 'Premium Stock Photo Collection 2024',
    description: '500+ high-resolution commercial-use images',
    price: 39.99,
    preview:
  ...
  },
  {
    id: 5,
    user_id: 5,
    title: 'Web Development Resource Bundle',
    description:
      'Curated collection of premium development tools and resources',
    price: 49.99,
    preview:
      'https://cdn.pixabay.com/photo/2016/11/30/20/58/programming-1873854_1280.png',
    content_url: 'https://github.com/trending',
    thumbnail:
      'https://cdn.pixabay.com/photo/2016/11/30/20/58/programming-1873854_1280.png',
    category_id: 5,
    created_at: new Date('2024-01-05'),
  ...
  },
  {
    id: 6,
    user_id: 6,
    title: 'UI/UX Design Kit 2024',
    description:
      'Complete design resource package with templates and components',
    price: 34.99,
    preview:
      'https://cdn.pixabay.com/photo/2017/01/29/13/21/mobile-2017983_1280.png',
    content_url: 'design-resources-2024.zip',
    thumbnail:
      'https://cdn.pixabay.com/photo/2017/01/29/13/21/mobile-2017983_1280.png',
    category_id: 6,
    created_at: new Date('2024-01-06'),
  ...
  },
  {
    ...
    description: 'Collection of timeless piano compositions',
    price: 24.99,
    preview: 'https://cdn.pixabay.com/audio/2022/11/17/audio_547db67f5f.mp3',
    content_url:
      'https://cdn.pixabay.com/audio/2022/11/17/audio_547db67f5f.mp3',
    thumbnail:
      'https://cdn.pixabay.com/photo/2015/05/07/11/02/piano-756383_1280.jpg',
    category_id: 2,
    created_at: new Date('2024-01-07'),
    updated_at: new Date('2024-01-07'),
  },
  {
    ...
    description: 'Step-by-step guide to personal finance management',
    price: 29.99,
    preview:
  ...
  },
  {
    ...
    description: 'Professional After Effects templates for video creators',
    price: 59.99,
    preview: 'https://cdn.pixabay.com/vimeo/367275573/motion-32773.mp4',
    content_url: 'motion-graphics-pack.zip',
    thumbnail:
  ...
  },
  {
    id: 10,
    user_id: 10,
    title: 'React & Next.js Development Course',
    description: 'Complete guide to modern React development',
    price: 44.99,
    preview: 'https://cdn.pixabay.com/vimeo/414804645/react-37984.mp4',
    content_url: 'https://cdn.pixabay.com/vimeo/414804645/react-37984.mp4',
    thumbnail:
  ...
  },
  {
    id: 12,
    user_id: 12,
    title: 'Digital Marketing Tools Collection',
    description: 'Curated suite of marketing automation tools',
    price: 79.99,
    preview:
      'https://cdn.pixabay.com/photo/2015/02/02/11/09/office-620822_1280.jpg',
    content_url: 'https://digitaltoolkit.com/resources',
    thumbnail:
      'https://cdn.pixabay.com/photo/2015/02/02/11/09/office-620822_1280.jpg',
    category_id: 5,
    created_at: new Date('2024-01-12'),
